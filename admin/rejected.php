...
<html lang="en">
    <?php
        ...
        {  
            ...
            $sql = "SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.u_id=users_orders.u_id WHERE users_orders.status='rejected' ORDER BY o_id ASC";  
        ...
        {  
            ...
            $obj_pdf->SetTitle("Zinnovare's Cancelled Orders Report");  
            ...
            $content = '';  
            $content .= '  
            <h3 align="center">Zinnovare\'s Cancelled Orders Report</h3><br /><br />  
            ...
            $obj_pdf->Output('Cancelled-Orders-Report.pdf', 'I');  
        } 
