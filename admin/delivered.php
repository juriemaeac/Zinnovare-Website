...
<html lang="en">
    <?php
        ...
        {  
            ...
            $sql = "SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.u_id=users_orders.u_id WHERE users_orders.status='closed' ORDER BY o_id ASC";  
        ...
        {  
            ...
            $obj_pdf->SetTitle("Zinnovare's Delivered Orders Report");  
            ...
            $obj_pdf->Output('Delivered-Orders-Report.pdf', 'I');  
        } 
