...
<html lang="en">
    <?php
        ...
        {  
            ...
            $sql = "SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.u_id=users_orders.u_id WHERE users_orders.status='in process' ORDER BY o_id ASC";  
        ...
        {  
            ...
            $obj_pdf->SetTitle("Zinnovare's On Process Orders Report");  
            ...
            $content = '';  
            $content .= '  
            <h3 align="center">Zinnovare\'s On process Orders Report</h3><br /><br />  
            ...
            $obj_pdf->Output('Process-Orders-Report.pdf', 'I');  
        } 
                ...
                <div class="container-fluid" style="padding-bottom:0">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">On Process Orders</h4>
