...
<html lang="en">
    <?php
        ...
        {  
            ...
            $sql = "SELECT users.*, users_orders.* FROM users INNER JOIN (SELECT * FROM users_orders where status='closed') users_orders ON users.u_id=users_orders.u_id ORDER BY o_id DESC";  
        ...
        {  
            ...
            $content = '';  
            $content .= '  
            <h3 align="center">Zinnovare\'s Delivered Orders Report</h3><br /><br />  
                                                ...
                                                <?php
                                                    ...
                                                    {				
                                                        while($rows=mysqli_fetch_array($query))
                                                        {
                                                            ...
                                                            ?>
                                                                <td>
                                                                <a href="delete_orders.php?order_del=<?php echo $rows['o_id'];?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10" style="background-color: red;"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
                                                            <?php
