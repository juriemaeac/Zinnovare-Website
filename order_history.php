        ...
        <div class="page-wrapper" style="padding-top: 150px;">
            ...
            <section class="restaurants-page">
                ...
                <!-- Start Page Content -->
                    ...
                    <div class="col-md-3">
                        <div class="card p-60" style="width: 30rem; box-shadow: 0 0 0 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                            <div class="media">
                                ...
                                <p>Order #<?php echo $row['o_id']; ?></p>
                                <p><?php echo $row['date']; ?></p>
                                <p><?php echo $row['title']; ?></p>
                                <p><?php echo $row['slogan']; ?></p>
                                <?php echo "<img src='src/".$row['img']."' style='width:50px; height:50px>'";?>
                                <p> 
                                    <span> Php <?php echo $row['price']; ?> </span>
                                    <span style="text-align: right;"> Qty: <?php echo $row['quantity']; ?> </span>
                                </p>
                                <hr>
                                <p> Total: Php <?php echo $row['price']*$row['quantity'] ; ?></p>
                                Status: <?php 
                                        $status=$row['status'];
