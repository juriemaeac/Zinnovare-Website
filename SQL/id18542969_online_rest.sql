...
--
-- Database: `id18542969_online_rest`
--
CREATE DATABASE IF NOT EXISTS `id18542969_online_rest` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `id18542969_online_rest`;
